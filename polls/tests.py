...
class PollViewTests(TestCase):
	...
	def test_index_view_with_a_future_poll(self):
		"""
		Polls with pub_date in the future should not be displayed on the index 
		page.
		"""
...
class PollIndexDetailTests(TestCase):
	...
	def test_detail_view_with_a_past_poll(self):
		"""
		The detail view of a poll with pub_date in the past should dispaly the 
		poll's question
		"""
